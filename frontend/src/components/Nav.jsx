...
function Nav() {
  ...
  return (
    <div>
      ...
      >
        ...
        <span
          className="flex items-center justify-center gap-2 text-white border-[2px] border-[#fdfbfb7a] bg-[#000000d5] rounded-lg px-[65px] py-[20px] text-[18px] hover:bg-[#111111] hover:border-white hover:scale-105 transition duration-300 ease-in-out cursor-pointer"
          onClick={() => navigate("/profile")}
        >
          My Profile
        </span>
  ...
  hover:bg-[#111111] hover:border-white hover:scale-105 transition duration-300 ease-in-out cursor-pointer"
          onClick={() => navigate("/enrolledcourses")}
        >
          My Courses{" "}
        </span>
        ...
        {userData?.role == "educator" ? (
          <div
            className="flex items-center justify-center gap-2 text-[18px] text-white border-[2px] border-[#fdfbfb7a] bg-[#000000d5] rounded-lg px-[60px] py-[20px]   hover:bg-[#111111] hover:border-white hover:scale-105 transition duration-300 ease-in-out cursor-pointer  "
            onClick={() => navigate("/dashboard")}
          >
            Dashboard
          </div>
        ...
        {!userData ? (
          <span
            className="flex items-center justify-center gap-2 text-[18px] text-white border-[2px] border-[#fdfbfb7a] bg-[#000000d5] rounded-lg px-[80px] py-[20px]  hover:bg-[#111111] hover:border-white hover:scale-105 transition duration-300 ease-in-out cursor-pointer"
            onClick={() => navigate("/login")}
          >
            Login
          </span>
          ...
          <span
            className="flex items-center justify-center gap-2 text-[18px] text-white border-[2px] border-[#fdfbfb7a] bg-[#000000d5] rounded-lg px-[75px] py-[20px]   hover:bg-[#111111] hover:border-white hover:scale-105 transition duration-300 ease-in-out cursor-pointer"
            onClick={handleLogout}
          >
            LogOut
          </span>
