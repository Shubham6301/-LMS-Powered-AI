...
const googleLogin = async () => {
  try {
    // ✅ Force logout first to prevent "already logged in" issue
    await signOut(auth);
    ...
    <div className="bg-[#dddbdb] w-[100vw] h-[100vh] flex items-center justify-center flex-col gap-3">
      ...
      >
        <div className="md:w-[50%] w-[100%] h-[100%] flex flex-col items-center justify-center gap-4 ">
          ...
          <span
            className="text-[13px] cursor-pointer text-[#585757] hover:text-black hover:underline"
          ...
          <div
            className="w-[80%] h-[40px] border border-[#d3d2d2] rounded-[5px] flex items-center justify-center 
             cursor-pointer hover:bg-gray-100 hover:shadow-md transition duration-200 ease-in-out"
            onClick={googleLogin}
          >
          ...
          <div className="text-[#6f6f6f]">
            ...
            <span
              className="underline underline-offset-1 text-black cursor-pointer 
               hover:text-blue-600 hover:underline hover:underline-offset-2 transition duration-200"
